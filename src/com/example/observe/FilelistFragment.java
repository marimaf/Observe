...
public class FilelistFragment extends ListFragment {
	...
	public static class FileEntry {
		...
		public FileEntry(File directory, String fname, String text, String small,
				FileTyper typer) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			view.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					TextView popup = (TextView) v.findViewById(R.id.textFileListName);
					...
					PopupMenuAdapter.PopupMenuItem popupItems[] = new PopupMenuAdapter.PopupMenuItem[] {
							new PopupMenuAdapter.PopupMenuItem(R.string.popup_share, 
							...
							new PopupMenuAdapter.PopupMenuItem(R.string.popup_rename, 
								new View.OnClickListener() {
								@Override
								public void onClick(View v) {
							...
							new PopupMenuAdapter.PopupMenuItem(R.string.popup_delete, 
								new View.OnClickListener() {
								@Override
								public void onClick(View v) {
									deleteFileDialog(mitem.getFile());
