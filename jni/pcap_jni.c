...
JNIEXPORT jboolean JNICALL Java_com_example_observe_PcapLogger_openPcap(JNIEnv *env, jobject this, jstring file, 
																		unsigned int dlt) {
	...
	class_pcaplogger = (*env)->FindClass(env, "com/example/observe/PcapLogger");
...
JNIEXPORT void JNICALL Java_com_example_observe_PcapLogger_closePcap(JNIEnv *env, jobject this) {
	jfieldID pcap_state_field;
...
JNIEXPORT jboolean JNICALL Java_com_example_observe_PcapLogger_logPacket(JNIEnv *env, jobject this,
																	  jobject packet) {
	...
	class_packet = (*env)->FindClass(env, "com/example/observe/Packet");
...
JNIEXPORT jboolean JNICALL Java_com_example_observe_PcapLogger_logPPIPacket(JNIEnv *env, jobject this,
																	  jobject packet) {
	jfieldID pcap_state_field, packet_bytes_field, packet_dlt_field;
	jclass class_ioex, class_pcaplogger, class_packet;
...
JNIEXPORT jint JNICALL Java_com_example_observe_PcapHelper_countPcapFile(JNIEnv *env, jobject this,
